...
export const commands = {
  optimizedWidth: (propValue: Arguments) => {
    if (typeof propValue === "boolean" && propValue)
      return `width:100%;width:-moz-available;width:-webkit-fill-available;`;
    return "";
  },
  optimizedHeight: (propValue: Arguments) => {
    if (typeof propValue === "boolean" && propValue)
      return `height:100%;height:-moz-available;height:-webkit-fill-available;`;
    return "";
  },
  borderRadius: (propValue: Arguments) => {
    if (typeof propValue === "string")
      return `border-radius:${propValue};-moz-border-radius:${propValue};-ms-border-radius:${propValue};-o-border-radius:${propValue};-webkit-border-radius:${propValue};`;
    return "";
  },
  userSelect: (propValue: Arguments) => {
    if (typeof propValue === "boolean" && propValue)
      return `user-select:none;-webkit-user-select:none;-moz-user-select:none;`;
    else if (typeof propValue === "string" && propValue)
      return `user-select:${propValue};-webkit-user-select:${propValue};-moz-user-select:${propValue};`;
    return "";
  },
  ...
  borderLeftColor: (propValue: Arguments) => {
    if (typeof propValue === "string") return `border-left-color:${propValue};`;
    return "";
  },
  ...
  boxSizing: (propValue: Arguments) => {
    if (typeof propValue === "string")
      return `box-sizing:${propValue};-moz-box-sizing:${propValue};-webkit-box-sizing:${propValue};`;
    return "";
  },
  ...
  textIndent: (propValue: Arguments) => {
    if (typeof propValue === "string")
      return `text-indent:${propValue};-moz-text-indent:${propValue};`;
    return "";
  },
  ...
  backgroundClipText: (propValue: Arguments) => {
    if (typeof propValue === "boolean" && propValue)
      return `-webkit-background-clip:text;-moz-background-clip:text;background-clip:text;`;
    return "";
  },
  backgroundTranslucent: (propValue: Arguments) => {
    if (typeof propValue === "boolean" && propValue)
      return `background-color:transparent;-webkit-background-clip:text;-moz-background-clip:text;-webkit-text-fill-color:transparent;-moz-text-fill-color:transparent;`;
    return "";
  },
  textFillColor: (propValue: Arguments) => {
    if (typeof propValue === "string")
      return `-webkit-text-fill-color:${propValue};-moz-text-fill-color:${propValue};`;
    else if (typeof propValue === "boolean" && propValue)
      return `-webkit-text-fill-color:transparent;-moz-text-fill-color:transparent;`;
    return "";
  },
  ...
  transition: (propValue: Arguments) =>
    `transition:${propValue};-webkit-transition:${propValue};-moz-transition:${propValue};-ms-transition:${propValue};-o-transition:${propValue};`,
  ...
  userDrag: (propValue: Arguments) => {
    if (typeof propValue === "string") {
      return `-webkit-user-drag:${propValue};-moz-user-drag:${propValue};user-drag:${propValue};`;
    }
    return "";
  },
  userResize: (propValue: Arguments) => {
    if (typeof propValue === "string") {
      return `-webkit-user-resize:${propValue};-moz-user-resize:${propValue};user-resize:${propValue};`;
    }
    return "";
  },
  ...
  transform: (propValue: Arguments) =>
    typeof propValue === "string"
      ? `transform:${propValue};-webkit-transform:${propValue};-moz-transform:${propValue};-ms-transform:${propValue};-o-transform:${propValue};`
      : "",
  ...
  placeHolderColor: (propValue: Arguments) =>
    typeof propValue === "string" ? `::placeholder { color:${propValue};}` : "",
  ...
  userSelectAuto: (propValue: Arguments) =>
    typeof propValue === "boolean" && propValue
      ? `user-select:auto;-webkit-user-select:auto;-moz-user-select:auto;`
      : "",
